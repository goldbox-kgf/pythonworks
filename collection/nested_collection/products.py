products=[
    {"id":1,"title":"s23ultra","brand":"samsung","price":150000},
...
# print mobile titles
titles_of=[p.get("title") for p in products]
print(titles_of)

# print samsung mobiles
samsung_phones=[p.get("title") for p in products if p.get("brand")=="samsung"]
print(len(samsung_phones))

# print all costly phones
